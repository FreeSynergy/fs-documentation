...
- Es gibt eine **konfigurierbare Default-Zuordnung** im Conductor (regelbasiert)
...
Im Conductor gibt es eine **regelbasierte Liste**:
...
[[bus.rules]]
condition = { topic = "*.install", source_role = "conductor" }
delivery = "guaranteed"
storage = "until_ack"
